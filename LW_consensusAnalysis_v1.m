...
mainLOC = [dirID , ':\Users\johna\Downloads\tempTransfer-selected (1)']; % NeuroWork
saveDIR = [dirID , ':\Users\johna\Downloads\tempTransfer-selected (1)\Summary']; % NeuroWork
...
switch stagE
    ...
    case 3 % Analysis
        ...
        load('Consensus1.mat','Con1Dat')
        load('ConsensusF.mat','ConFDat')
